...
- **البيانات**: Firebase — Auth بالبريدِ وكلمةِ المرور + Firestore عبر REST (بلا SDK)، بالطريقةِ نفسِها المستعملةِ في منصّة «مدرستي».
...
1. **فايربيس**: في مشروعِك (الافتراضيُّ في `config.js` هو المشروعُ المشتركُ مع مدرستي `vak-quiz-96d5f`):
